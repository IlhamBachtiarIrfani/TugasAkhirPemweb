...
<body>
    ...
    <div class=" row">
        ...
        <div class="col-lg-6">
            <img src="../dist/img/rafiki.png" class="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="473"
                height="362" loading="lazy">
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="text-center mt-5 mb-3"
                        style="font-family: Playfair Display; font-weight: 900; font-size: 32px">Gabung dan Tingkatkan
                        Kemampuan
                        wirausahamu</h1>
                </div>
    ...
    <div class="container my-5" ">
        <div class=" row mt-5">
        <div class="col-lg-6">
            <img src="../dist/img/hihi.png" class="d-block img-fluid" alt="Bootstrap Themes" width="473" height="362"
                loading="lazy">
        </div>
        <div class="col-lg-6">
            <h1 class="mt-5 mb-3" style="font-family: Playfair Display; font-weight: 900; font-size: 32px;">
    ...
    <div class="container my-5">
        <div class="row mt-5 pt-5">
            <div class="col-lg-12 mx-auto pt-5">
                <img src="../dist/img/pendapat.png" style="display: block; margin: 0 auto;" />
            </div>
        </div>
    </div>
